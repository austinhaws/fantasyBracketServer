 ...
 */
module.exports = (tableName, idField) => {
	const model = {
		...
		insert: (data, callback) => connection.query(`INSERT INTO ${tableName} SET ?`, convertKeys.toSnake(data), queryResults.insertCallback(callback, idField)),
